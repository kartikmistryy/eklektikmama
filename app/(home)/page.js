...
export default function Home() {
  ...
  return (
    <>
      <NewsletterPopup />
      <div className="w-full h-full flex flex-col bg-[#231f20] lg:pt-[180px] pt-[120px] relative overflow-hidden">
            ...
            <main className="w-full h-full flex items-center justify-start lg:pt-[30px] md:pt-[120px] pt-[80px] relative px-5 overflow-visible">
              <div className="w-full h-full lg:max-w-[1000px] md:max-w-[600px] max-w-[380px] mx-auto relative overflow-visible z-2">
                <h1 className="lg:text-[6.5rem] md:text-[4rem] text-[50px] tracking-tight leading-[130%] font-anton font-bold uppercase text-white w-fit mx-auto relative z-0 px-[0px]">
                  ...
                  Shaking Up <br className="lg:hidden flex" /> Mamahood{" "}
          ...
          <div className="w-full h-full flex flex-col justify-start items-start md:basis-1/2 basis-full md:pl-14 md:pr-0 px-5 text-[#093166]">
            ...
            >
              ...
              >
                ...
                mornings — where mums come to connect, be challenged, laugh too
                loud, and feel seen in all their contradictions. This is where
              ...
              >
                <p className="pt-4">
                  ...
                  that sounds like your kind of mess, welcome home. Because
                  motherhood doesn&apos;t need a filter. <br />
                  It needs fire, grit, and a space where your loud, raw,
                  unpolished self isn&apos;t just accepted — it&apos;s
                  celebrated.
                </p>
              </motion.div>
            </motion.div>
                  ...
                  <div className="w-full h-full min-h-[400px] flex flex-col col-span-1 p-3 rounded-sm border-2 border-[#093166]">
                    ...
                    <span className="py-4 w-full h-full flex flex-col justify-start items-start relative">
                      ...
                      <span className="w-full h-fit mt-auto flex flex-row items-center justify-between pr-2">
                        <Link
                          href="/events"
                          className="text-sm text-white rounded-full font-medium font-poppins flex flex-row uppercase items-center bg-[#093166] justify-start gap-5 px-3 py-1.5 "
                        >
                          SEE THE LINEUP{" "}
                          <BsArrowRight className="text-lg font-bold" />
                        </Link>
                  ...
                  <div className="w-full h-full flex flex-row col-span-3 min-h-[300px] p-3 rounded-sm gap-5 border-2 border-[#093166]">
                    ...
                    <span className="py-4 w-full h-full flex flex-col justify-start items-start relative basis-1/2">
                      ...
                      <span className="w-full h-fit mt-auto flex flex-row items-center justify-between pr-2">
                        <Link
                          href="/blogs"
                          className="text-sm bg-[#093166] text-white rounded-full font-medium font-poppins uppercase flex flex-row items-center justify-start gap-5 px-3 py-1.5 "
                        >
                          READ THE BLOG
                          <BsArrowRight className="text-lg font-bold" />
                        </Link>
                  ...
                  <div className="bg-pink-400 w-full h-full flex flex-col self-stretch col-span-2 p-3 rounded-sm gap-5 overflow-hidden">
                    ...
                    <span className="py-4 w-full h-full flex flex-col justify-start items-start relative">
                      ...
                      <p className="text-base font-quicksand text-white font-medium">
                        ...
                        identity crises, and the joy that comes with it all.
                        These are the brands that show up, stand out, and
                        actually give a damn. Think everyday magic, minus the
                        pastel pandering. If they&apos;re on this list, it means
                        they passed the vibe check - hard.
                      </p>
                      <span className="w-full h-fit mt-auto flex flex-row items-center justify-between pr-2">
                        <Link
                ...
                <CarouselItem className="basis-full">
                  <div className="bg-white w-full min-h-[500px] p-4 rounded-sm flex flex-col gap-3 border-2 border-[#093166]">
                    ...
                    <div className="mt-auto flex flex-row items-center justify-between">
                      <Link
                        href="/events"
                        className="text-sm text-white rounded-full font-medium font-poppins flex flex-row items-center bg-[#093166] gap-3 px-3 py-1.5"
                      >
                        SEE THE LINEUP{" "}
                        <BsArrowRight className="text-lg font-bold" />
                      </Link>
                ...
                <CarouselItem className="basis-full">
                  <div className="bg-white w-full min-h-[500px] p-4 rounded-sm flex flex-col gap-3 border-2 border-[#093166]">
                    ...
                    <div className="mt-auto flex flex-row items-center justify-between">
                      <Link
                        href="/blogs"
                        className="text-sm bg-[#093166] text-white rounded-full font-medium font-poppins flex flex-row items-center gap-3 px-3 py-1.5"
                      >
                        READ THE BLOG{" "}
                        <BsArrowRight className="text-lg font-bold" />
                      </Link>
