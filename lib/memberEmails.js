        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="info-box">
              ...
              <p>You'll still have access to all your perks until <strong>${new Date(currentPeriodEnd).toLocaleDateString()}</strong>:</p>
              <ul>
...
You'll still have access to all your perks until ${new Date(currentPeriodEnd).toLocaleDateString()}:
