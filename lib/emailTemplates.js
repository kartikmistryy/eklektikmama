      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="qr-section">
            ...
            <!-- QR Code Image -->
            <div style="text-align: center; margin: 20px 0; background: white; padding: 15px; border-radius: 8px; border: 2px solid #ddd;">
              ...
              <p style="margin: 10px 0 0 0; font-size: 12px; color: #666;">
                <small>📱 Your entry QR code</small>
              </p>
            </div>
            ` : `
            <!-- QR Code Placeholder -->
            <div style="text-align: center; margin: 20px 0; background: #f8f9fa; border: 2px dashed #dee2e6; border-radius: 8px; padding: 40px;">
              ...
              <p style="margin: 10px 0 0 0; font-size: 12px; color: #999;">
                <small>If the QR code doesn't display above, use the alternative entry methods below.</small>
              </p>
            </div>
            `}
