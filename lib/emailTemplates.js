          ...
          <div class="section">
            ...
            <ol>
              ...
              <li><strong>Download your digital perks right now:</strong>
                <ul>
                  <li><a href="${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/mamaMilestoneCards.pdf" style="color: #DB4E9F;">Mama Milestones Cards</a></li>
    ...
    attachments: [
      {
        ...
        path: process.cwd() + '/public/mamaMilestoneCards.pdf'
      }
    ]
  };
}
